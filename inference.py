...
DEFAULT_MODEL_PATH = os.path.join(MODEL_DIR, 'baseline_fp16.pth')
...
def main():
    ...
    p.add_argument('--precision', type=str, choices=['fp32', 'fp16'], default='fp32',

                   help='Model and inference precision')
    ...
    # 根據 --dtype 決定是否轉成 half precision
